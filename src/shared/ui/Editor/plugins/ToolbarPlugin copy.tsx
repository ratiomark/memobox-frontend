...
import { ChangeEventHandler, DetailedHTMLProps, Dispatch, MutableRefObject, OptionHTMLAttributes, SetStateAction, useCallback, useEffect, useMemo, useRef, useState } from 'react';
import {
	CAN_REDO_COMMAND,
	CAN_UNDO_COMMAND,
	REDO_COMMAND,
...
import { select } from '@/pages/AboutPage/react-i18next';
...
interface BlockOptionsDropdownListProps {
	...
	toolbarRef: MutableRefObject<null>
	setShowBlockOptionsDropDown: Dispatch<SetStateAction<boolean>>
}

function BlockOptionsDropdownList(props: BlockOptionsDropdownListProps) {
	const {
		editor,
		blockType,
		toolbarRef,
		setShowBlockOptionsDropDown } = props
